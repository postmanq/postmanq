...
//
//	mockgen -source config/services.go -package config_mock -destination config_mock/services.go
//
...
import (
	...
	config "github.com/postmanq/postmanq/pkg/commonfx/configfx/config"
