...
//
//	mockgen -source temporal/services.go -destination temporal_mocks/services.go
//
...
import (
	context "context"
	temporal2 "github.com/postmanq/postmanq/pkg/commonfx/temporalfx/temporal"
	reflect "reflect"
...
func (m *MockWorkerFactory) Create(ctx context.Context, workflowType temporal2.WorkflowType) (temporal2.Worker, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, workflowType)
	ret0, _ := ret[0].(temporal2.Worker)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWorker) RegisterWorkflowWithType(workflowType temporal2.WorkflowType, i any) {
	m.ctrl.T.Helper()
...
func (m *MockWorkerOption) Apply(arg0 *temporal2.WorkerSettings) {
	m.ctrl.T.Helper()
...
func (m *MockWorkflowDescriptor) GetWorkflowType() temporal2.WorkflowType {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWorkflowType")
	ret0, _ := ret[0].(temporal2.WorkflowType)
	return ret0
}
...
// Apply mocks base method.
func (m *MockWorkflowOption) Apply(settings *temporal2.WorkflowSettings) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockWorkflowExecutorFactory[I, O]) Create(options ...temporal2.WorkflowOption) temporal2.WorkflowExecutor[I, O] {
	m.ctrl.T.Helper()
	varargs := []any{}
	...
	ret0, _ := ret[0].(temporal2.WorkflowExecutor[I, O])
	return ret0
}
